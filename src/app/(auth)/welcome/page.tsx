...
const Page = () => {
  ...
  return (
    <div className="flex w-full flex-1 items-center justify-center px-4">
      ...
      <div className="reltive z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center">
        <LoadingSpinner size={"md"} />
        <Heading>Creating your account...</Heading>
        <p className="text-base/7 text-gray-600 max-w-pose">Just a moment</p>
      </div>
    </div>
  )
}
